 ...
 * 
 * 
 * 1c - ignorata butoanelela initializare
 */
...
if (STATUS0 != STATUS)
{
  LEDoff();
//  initializare();  
  if (STATUS == 1) digitalWrite(LED1, HIGH);
  if (STATUS == 2) digitalWrite(LED2, HIGH);
  if (STATUS == 3) digitalWrite(LED3, HIGH);
  if (STATUS == 4) digitalWrite(LED4, HIGH);
initializare();  
STATUS0 = STATUS;
}

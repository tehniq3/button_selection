 ...
 * 1d1 - lasat initializare doar la pornire sistem
 */
...
void initializare()  
{
  Serial.println("Initializare la pornire ...");
  digitalWrite(LED0, HIGH);
  intarziere0(10000);
  digitalWrite(LED0, LOW);
  intarziere0(1000);
  Serial.println("Terminare initializare...");
}
...
void setup() {
  ...
  Serial.println("ver. 1d1 - 12.8.2022, Craiova");
  Serial.println("---------------------");
  pinMode (LED0, OUTPUT);
  pinMode (LED1, OUTPUT);
  pinMode (LED2, OUTPUT);
